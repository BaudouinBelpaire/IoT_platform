...
<p align="center"><img src= "https://github.com/DIEGO15457/Final-Project/blob/main/assets/WiFi_Tx_receiver_wiring.png", width="200" height="auto"></p>
...
[5] Kubov, V. I., Dymytrov, Y. Y., Stojanović, R., Kubova, R. M., & Škraba, A. (2020, June). A Feasible IoT System for Monitoring PPG and ECG Signals by using Low-cost Systems-on-chips and HTML Interface. In 2020 9th Mediterranean Conference on Embedded Computing (MECO) (pp. 1-4). IEEE.‏ DOI: 10.1109/MECO49872.2020.9134219
