...
The [CSV file](https://github.com/BaudouinBelpaire/IoT_platform/main/assets/Sensing_nodes_data.csv) obtained from the data collection with MongoDB is also accessible here.  
